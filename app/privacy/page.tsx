      ...
      <InfoPage
        ...
        sections={[
          ...
          },
          {
            ...
            body: "We use account and game data to authenticate you, maintain your library, calculate progress, provide Vault recommendations, run Purge reviews, keep collections and wishlists current, prevent abuse, diagnose faults and respond to support. This processing is necessary to provide the service you request and, for security and service improvement, supports our legitimate interests in operating a reliable product."
          },
          {
