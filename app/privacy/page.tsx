      ...
      <InfoPage
        ...
        sections={[
          ...
          },
          {
            ...
            body: "Essential cookies and local storage keep you signed in, remember interface preferences and record your analytics choice. Vercel service telemetry is used for hosting reliability. PostHog product analytics are off until you turn them on, and use first-party cookie and local-storage persistence once enabled. When you are signed in, VaultShuffle identifies your PostHog analytics profile using our internal user ID and attaches your SteamID, Steam display name, Steam profile link and avatar where available. PostHog is used for product-usage events, heatmaps, error and performance information, feature analysis and session replay so we can understand how the service is used and improve it. Session replay masks form and input values, although visible interface content and interactions may be recorded. You can turn PostHog analytics off at any time through Analytics Settings."
          },
          {
